...
<div class="relative flex-reverse">
    ...
    <div
        class="absolute top-0 right-12 w-72 h-auto py-3 px-5 bg-splash bg-opacity-80 shadow-md text-white text-sm font-light leading-tight transition-all duration-150"
        class:opacity-100="{isActive}"
