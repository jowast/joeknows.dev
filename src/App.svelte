...
import FloatingMenuItem from "./components/FloatingMenuItem.svelte";
...
<Splash hidden="{continued}" loaded="{loaded}" on:click="{onContinue}" />

<Scene animate="{continued}" on:load="{onLoad}" />

{#if continued}
	<FloatingMenu>
		<FloatingMenuItem icon="/img/controls.png" label="Controls">
			<ul>
		...
		<FloatingMenuItem icon="/img/information.png" label="Information">
			<p>
				Welcome to <span class="font-medium"
					>The "Hire Me" Simulator</span
				>, where you can review my resume in 3D! Step into the virtual
				world and instantly become a hiring manager, seated in your
				office, with my resume in hand.
				<br />
				<br />
				Your task: <span class="font-medium">review my resume.</span> Do
